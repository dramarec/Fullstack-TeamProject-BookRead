...
console.log('book1',book._id);
  ...
  const onHandleChange = (e) => {
    ...
    const onHandleSubmit = (e) => {
        e.preventDefault();
        dispatch(changeBookOperation(  book._id, {review:  book.review} ))
    ...
    return (
        <ReviewModalStyled onSubmit={onHandleSubmit} >
           ...
           <Star />
           <p>Резюме</p>
           <input className="form-control" rows="5" type="textarea" name="review" value={book.review} onChange={onHandleChange}/>
